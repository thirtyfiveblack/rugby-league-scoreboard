...
class BaseNCAAMBasketballManager(RugbyLeague):
    ...
    def _fetch_data(self) -> Optional[Dict]:
        ...
        if isinstance(self, NCAAMBasketballLiveManager):
            ...
            data = self._fetch_ncaam_api_data(use_cache=True)
...
class NCAAMBasketballLiveManager(BaseNCAAMBasketballManager, RugbyLeagueLive):
